...
<head>
	...
	<title>&quot;DynamicProto&quot; | @microsoft/dynamicproto-js</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="../index.html">@microsoft/dynamicproto-js</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter">
			<a href="_dynamicproto_.html#dynamicprotodelegate" class="tsd-kind-icon">Dynamic<wbr>Proto<wbr>Delegate</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="_dynamicproto_.html#_hasvisited" class="tsd-kind-icon">_has<wbr>Visited</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter">
			<a href="_dynamicproto_.html#dynamicproto" class="tsd-kind-icon">dynamic<wbr>Proto</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter"><a href="_dynamicproto_.html#dynamicprotodelegate" class="tsd-kind-icon">Dynamic<wbr>Proto<wbr>Delegate</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							...
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter"><a href="_dynamicproto_.html#dynamicproto" class="tsd-kind-icon">dynamic<wbr>Proto</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter">
				<a name="dynamicprotodelegate" class="tsd-anchor"></a>
				<h3>Dynamic<wbr>Proto<wbr>Delegate</h3>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/microsoft/DynamicProto-JS/blob/2594e3b/lib/src/DynamicProto.ts#L340">DynamicProto.ts:340</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The delegate signature for the function used as the callback for dynamicProto()</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>param</dt>
						<dd><p>This is the real &quot;this&quot; of the current target object</p>
						</dd>
						<dt>param</dt>
						<dd><p>The is a proxy object which ONLY contains this function that existed on the &quot;this&quot; instance before
							calling dynamicProto, it does NOT contain properties of this. This is basically equivalent to using the &quot;super&quot; keyword.</p>
						</dd>
					</dl>
				</div>
				...
				<ul class="tsd-type-parameters">
					<li>
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>This is the generic type of the class, used to keep intellisense valid for the proxy instance, even
								though it is only a proxy that only contains the functions</p>
							</div>
						</div>
					</li>
				</ul>
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-siganture">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-alias">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>theTarget<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">DPType</span>, baseFuncProxy<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">DPType</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									...
									<ul class="tsd-parameters">
										<li>
											<h5>theTarget: <span class="tsd-signature-type">DPType</span></h5>
										</li>
										<li>
											<h5><span class="tsd-flag ts-flagOptional">Optional</span> baseFuncProxy: <span class="tsd-signature-type">DPType</span></h5>
										</li>
									</ul>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
				<a name="_hasvisited" class="tsd-anchor"></a>
				<h3>_has<wbr>Visited</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">_has<wbr>Visited<span class="tsd-signature-symbol">(</span>values<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span>, value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/microsoft/DynamicProto-JS/blob/2594e3b/lib/src/DynamicProto.ts#L174">DynamicProto.ts:174</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns whether the value is included in the array</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter">
				<a name="dynamicproto" class="tsd-anchor"></a>
				<h3>dynamic<wbr>Proto</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter">
					<li class="tsd-signature tsd-kind-icon">dynamic<wbr>Proto&lt;DPType, DPCls&gt;<span class="tsd-signature-symbol">(</span>theClass<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">DPCls</span>, target<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">DPType</span>, delegateFunc<span class="tsd-signature-symbol">: </span><a href="_dynamicproto_.html#dynamicprotodelegate" class="tsd-signature-type">DynamicProtoDelegate</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DPType</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/microsoft/DynamicProto-JS/blob/2594e3b/lib/src/DynamicProto.ts#L393">DynamicProto.ts:393</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Helper function when creating dynamic (inline) functions for classes, this helper performs the following tasks :-</p>
								<ul>
									<li>Saves references to all defined base class functions</li>
									<li>Calls the delegateFunc with the current target (this) and a base object reference that can be used to call all &quot;super&quot; functions.</li>
									<li>Will populate the class prototype for all overridden functions to support class extension that call the prototype instance.
										...
										<pre><code class="language-typescript"><span class="hljs-keyword">import</span> dynamicProto <span class="hljs-keyword">from</span> <span class="hljs-string">"@microsoft/dynamicproto-js"</span>;
<span class="hljs-keyword">class</span> ExampleClass <span class="hljs-keyword">extends</span> BaseClass {
  <span class="hljs-keyword">constructor</span>(<span class="hljs-params"></span>) {
      dynamicProto(ExampleClass, <span class="hljs-keyword">this</span>, <span class="hljs-function">(<span class="hljs-params">_self, base</span>) =&gt;</span> {
          <span class="hljs-comment">// This will define a function that will be converted to a prototype function</span>
          _self.newFunc = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
              <span class="hljs-comment">// Access any "this" instance property</span>
              <span class="hljs-keyword">if</span> (_self.someProperty) {
                  ...
              }
          }
          <span class="hljs-comment">// This will define a function that will be converted to a prototype function</span>
          _self.myFunction = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
              <span class="hljs-comment">// Access any "this" instance property</span>
              <span class="hljs-keyword">if</span> (_self.someProperty) {
                  <span class="hljs-comment">// Call the base version of the function that we are overriding</span>
                  base.myFunction();
              }
              ...
          }
          _self.initialize = <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> {
              ...
          }
          <span class="hljs-comment">// Warnings: While the following will work as _self is simply a reference to</span>
          <span class="hljs-comment">// this, if anyone overrides myFunction() the overridden will be called first</span>
          <span class="hljs-comment">// as the normal JavaScript method resolution will occur and the defined</span>
          <span class="hljs-comment">// _self.initialize() function is actually gets removed from the instance and</span>
          <span class="hljs-comment">// a proxy prototype version is created to reference the created method.</span>
          _self.initialize();
      });
  }
}</code></pre>
						...
						<ul class="tsd-type-parameters">
							<li>
								<h4>DPType</h4>
								<div class="tsd-comment tsd-typography">
									<p>This is the generic type of the class, used to keep intellisense valid</p>
								</div>
							</li>
							<li>
								<h4>DPCls</h4>
								<div class="tsd-comment tsd-typography">
									<p>The type that contains the prototype of the current class</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>theClass: <span class="tsd-signature-type">DPCls</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>This is the current class instance which contains the prototype for the current class</p>
								</div>
							</li>
							<li>
								<h5>target: <span class="tsd-signature-type">DPType</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The current &quot;this&quot; (target) reference, when the class has been extended this.prototype will not be the &#39;theClass&#39; value.</p>
								</div>
							</li>
							<li>
								<h5>delegateFunc: <a href="_dynamicproto_.html#dynamicprotodelegate" class="tsd-signature-type">DynamicProtoDelegate</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DPType</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The callback function (closure) that will create the dynamic function</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
